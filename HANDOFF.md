...
- 🔴 **`FFACT_WARMUP_TRIM` 預設 `0`（嚴格窗）**：起始日之前的資料根本不抓，L6.5 之「前 500 根校準」即輸出範圍之前 500 根（2026-09-24 研究 r1 據此推翻主委之「校準在 warmup」判斷）；平穩化判定之無洩漏落點由 RM-FFSTAT 研究 r2 決定。
