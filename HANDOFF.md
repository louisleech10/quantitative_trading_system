...
| 序 | 識別碼 | 狀態 | 權威路徑 | 下一步 |
|---|---|---|---|---|
| 02-014 | SU-B10B | 進行中 | docs/SPLITUNIFY_TODO.md §C-10 | Task 10.3 投影判側錨點改為特徵列鍵＋v10 golden |
| 03-005 | R-5 | 進行中 | docs/SPLITUNIFY_SPEC.md Phase 10 | B10A 已收批（八輪審碼閉合，三家 proceed）；開工 B10B：Task 10.3 投影判側錨點改為特徵列鍵＋v10 golden |
