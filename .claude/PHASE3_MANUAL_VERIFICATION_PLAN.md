...
**Phase 3.1: EMA 指標計算**
- [x] 3.1.1: EMA計算正確性（與 pandas ewm 對比，誤差 < 1e-8）
- [x] 3.1.2: 參數驗證（範圍 2-200）
- [x] 3.1.3: safe_calculate 性能（< 10ms）
...
**Phase 3.3: 策略配置 UI**
- [x] 3.3.1: 頁面基本功能
- [x] 3.3.2: 三線 EMA 參數輸入（含約束驗證）
- [x] 3.3.3: 執行策略測試（API 請求格式正確）

**Phase 3.4: 圖表信號標記**
- [x] 3.4.1: 三線信號標記顯示（多頭/空頭排列）
- [x] 3.4.2: 圖表互動功能
