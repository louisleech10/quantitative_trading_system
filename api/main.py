...
def register_routes(app: FastAPI):
    ...
    try:
        ...
        # Register optimization routes (Phase 3 Task 3.5)
        app.include_router(
            optimization.router,
            tags=["Optimization"]
        )

        # Register Phase 4 optimization routes (Phase 4.3)
        app.include_router(
            hyperparameter_optimization.router,
            tags=["Hyperparameter Optimization"]
        )
        app.include_router(
            execution_optimization.router,
            tags=["Execution Optimization"]
        )

        # Register optimization WebSocket (Phase 3 Task 3.5)
        app.include_router(
            optimization_ws.router,
            tags=["WebSocket"]
        )
        ...
        # Register IC analysis WebSocket (Phase 2 Task 2.4.1)
        app.include_router(
            ic_analysis_ws.router,
            tags=["WebSocket"]
        )
        ...
        # Register feature engineering routes (Phase 4 Task 4.1)
        app.include_router(
        ...
        # Register pattern management routes (Phase 4 Task 4.3)
        app.include_router(
        ...
        # Register ML Pipeline routes (Phase 3-6 Frontend Integration)
        app.include_router(
            ml_pipeline.router,
            tags=["ML Pipeline"]
        )
        ...
        # Register watchlist persistence routes (Phase D)
        app.include_router(
            watchlist.router,
            tags=["Watchlist"]
        )
