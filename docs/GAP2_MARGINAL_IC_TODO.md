...
## 階段 4 handoff
`SPEC=docs/GAP2_MARGINAL_IC_SPEC.md AMEND=docs/GAP2_MARGINAL_IC_AMENDMENTS.md TODO=docs/GAP2_MARGINAL_IC_TODO.md FOCUS=B1 實作（Task 1.0→1.1→1.2→1.3；主委自任；三家 code review）`
