...
**＋延伸檔 `docs/GAP1_STRATEGY_OVERFIT_AMENDMENTS.md`（A1-1..A1-23；衝突時以延伸檔為準）**
...
- 🔴 **R2 之延伸檔優先序**：本 TODO 與 `docs/GAP1_STRATEGY_OVERFIT_AMENDMENTS.md`（A1-1..A1-23）一致；
...
| **延伸檔 A1-1..A1-23（R2）** | 收斂處置之 SPEC 義務側 | 各 Task 之 `SPEC ref` 已逐條標 A1-n；淨變動摘要見延伸檔末表 |
| Phase 依賴 | B1→B2→B3→B4（**R2：2.4 移入 B4 ⇒ B4 依賴 B3**） | §B 表 |
| 合計 | SPEC Task 15／§G 3 類／§V 15＋1／§N 8（−R8＋R9） | TODO Task 15／全對應 |

## 階段 3 自檢（R2 重跑）
1. 追溯：15/15 Task；§G／§V／§N／**A1-1..A1-23** 全對應；無真遺漏。
