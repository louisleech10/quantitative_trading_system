...
| `C5-26` | `pipeline` 之 summary counts（`n_train`／`n_test`／`n_purged`）〔ANCHOR `momentum/Analysis/event_samples/pipeline.py:860` TOKENS `"n_train"` `:` `int` `(` `plan` `.` `assignments` `.` `loc` `[` `plan` `.` `assignments` `[` `"split_label"` `]` `==` `"train"` `,` `"event_id"` `]` `.` `nunique` `(` `)` `)` `if` `not` `plan` `.` `assignments` `.` `empty` `else` `0` `,`〕〔ANCHOR `momentum/Analysis/event_samples/pipeline.py:861` TOKENS `"n_test"` `:` `int` `(` `plan` `.` `assignments` `.` `loc` `[` `plan` `.` `assignments` `[` `"split_label"` `]` `==` `"test"` `,` `"event_id"` `]` `.` `nunique` `(` `)` `)` `if` `not` `plan` `.` `assignments` `.` `empty` `else` `0` `,`〕〔ANCHOR `momentum/Analysis/event_samples/pipeline.py:862` TOKENS `"n_purged"` `:` `int` `(` `plan` `.` `purged` `[` `"event_id"` `]` `.` `nunique` `(` `)` `)` `if` `not` `plan` `.` `purged` `.` `empty` `else` `0` `,`〕 | 丙 | 以 `event_id` 去重計數；列數另立新名 | `Task 9.4` | `M-SU-D2-13` |
