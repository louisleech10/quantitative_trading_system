...
| 0620 | B-62 | 部分完成 | 批次間閘只驗「有沒有派出去審」不讀裁決，且只在派工給委員時觸發——主委自任實作從未經過；收斂檔掉意見無機械擋 | SPEC v9 停輪＋TODO v3 FROZEN（三家戳記）；B1–B4 皆三家審碼＋原提出方閉合 CLOSED；四掛載點 E-022～E-025 ｜還缺：SPLITUNIFY 補裁決輪（§E E-4）；收票審（C-4 範圍修正「只擋進入新批」須三家核）；§E E-1～E-7 逐條確認理由後結案 |
