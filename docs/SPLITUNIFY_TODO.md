...
| 150 | SU-B10C | 進行中 | docs/SPLITUNIFY_TODO.md §C-10 | r15 兩條 P1 已修補收斂（coverage 下沉 momentum、IC 主路徑接處置帳）；r16 閉合輪審碼中 |
...
| 050 | R-5 | 進行中 | docs/SPLITUNIFY_SPEC.md Phase 10 | B10A／B10B 已收批；B10C 進行中：r15 兩條 P1 已修補收斂，r16 閉合輪審碼中 |
