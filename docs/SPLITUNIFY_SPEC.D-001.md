...
4. 🔴 **`position` 之語意與 producer attest**
   ...
   🔴 **本點為 R12 後之重寫版（2026-09-12）**：R6～R12 之決策沿革（某輪曾如何、為何不採某方案）**一律不在本檔重述**，見 `handoffs/reconcile/20260911-splitunify-x-review-r6/synth.md` 至 `…-r12/synth.md`。本檔只留**現行態義務**，逐條編號以便機械比對是否遺漏。
