...
| 041 | HP-FFSTAT | 進行中 | docs/FFSTAT_SPEC.md | 2026-09-24 使用者第 4 點開票；SPEC v5 經 r1–r5 兩家收斂（commit `ae8b3cba`）；白話審閱（白話說明/FF-STAT規格審閱.md）時使用者連問免檢表抽樣、全量 ADF 成本、前 500 根抽樣誤差，並指示「將量化業界和統計分析怎麼做考量進去做研究」⇒ 研究 r1 已收斂（handoffs/reconcile/20260924-ffstatres-x-consult-r1/synth.md 已銷帳）；研究 r2（校準值之無洩漏落點甲＝訓練段／乙＝起始日前預熱，與窗長）派出中。成本收據 handoffs/run_receipts/20260924-ffstat-adf-cost.json（L1＋L2 90,006 欄全量約 194 秒／標的／次） |
