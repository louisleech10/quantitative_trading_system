...
| **實作** | **第三批已審兩輪**（6 條 → 3 條，全修）；第二輪確認第一輪的反例全死，但抓到我修第一輪時新弄出來的一條；等第三輪閉合 |
| Task 總數 | **42** |
| 已完成 | **10** |
| 進行中 | **1** |
| 未開工 | **31** |
...
**第四批＝匯入前端**（1.5、1.6、1.7）：上傳／預覽／欄位對映的 UI、對映過程的存證、
以及「這個欄看起來有問題」的警示。前置（第二批）已完成。

---

## 第三批做了什麼（2026-08-25；第一輪審查 6 條全修，等閉合輪）
