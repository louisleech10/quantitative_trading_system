...
brief-kind: stamp
task-id: 20260911-VERDICTGATE-X-STAMP-R11
findings-round: R11
...
🔴 **codex 專屬**：你 R10 之 `CODEX-R10-P1-01`／`P1-02`／`P2-03` 在 TODO v3 是否閉合——重驗後在交件檔末段機械塊寫 `CLOSED:`；未閉合者寫 `BLOCKED-BY:` 並蓋 REJECTED。

## 🔴 交件形態（缺這段整輪會銷不了帳）

無論結論為何，**交件檔內必須至少有一個 canonical heading**：
- 有問題 → `## <FAMILY>-R11-P<0-3>-<NN>`，含 `**斷言**`／`**碼證**`／`**來源摘要**`（P0/P1 須 12 位雜湊）。
