...
MUTATIONS: Tuple[Mutation, ...] = (
    ...
    Mutation("P14-cache-key-without-revision", 1, PROJ, "        key = (task_id, revision, sort_by, sort_order, _key_part(pass_class), _key_part(search))\n", "        key = (task_id, 0, sort_by, sort_order, _key_part(pass_class), _key_part(search))\n", [*PYTEST, T, "-k", "cache_key_includes_revision"], "快取 key 不含 revision ⇒ 紅"),
