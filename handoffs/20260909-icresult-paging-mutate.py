...
MUTATIONS: Tuple[Mutation, ...] = (
    ...
    Mutation("P10-snapshot-rereads-result", 1, SVC, "            return task_info.get(\"result\"), task_info.get(\"result_revision\")\n", "            return self._tasks.get(task_id, {}).get(\"result\"), task_info.get(\"result_revision\")\n", [*PYTEST, T, "-k", "revision_mid"], "投影中重讀 result ⇒ G-7b 紅"),
