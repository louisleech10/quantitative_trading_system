...
| F-4 | **E-10 收斂裁決未落到 SPEC**：R2 收斂已定 ≥50 筆 ＋ ≥3 session／UTC 日，SPEC 仍寫 ≥20，且 10–19 區間未定義 | `CODEX-R3-P1-04`／`COMPOSER-R3-P1-02` | **ACCEPT-BLOCKING**（主委漏改） |
| F-5 | **Task 2.0 契約計數漂移**：驗收稱「10 項」，實際條目含 `1`／`1b`／`2`–`10` 共 **11 項** | `COMPOSER-R3-P2-01` | **ACCEPT**（同 `票 B-17` 病型，本 SPEC 第二次） |
| F-6 | **Task 2.1 未列 1b 的具名語料** ⇒ 實作者可能只抄原型③（不含 1b）即通過 | `COMPOSER-R3-P1-01` | **ACCEPT** — 補四條 `b15probe6` 語料並納入語料 B |
