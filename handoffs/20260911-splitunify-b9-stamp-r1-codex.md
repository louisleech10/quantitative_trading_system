...
<!-- 主委（claude）2026-09-13 之**唯一**改動，依 scripts/debt_clear.sh:394 之設計路徑
     ...
     原字面為 `CLOSED: 2026-09-13`（日期），不合 CLOSED 契約（須為空值或 finding ID 清單），
     被 verdict_parse 拒收。本輪 codex 未閉合任何既有 finding（它開了四條新的）⇒ 正確值為空。
     🔴 除本行外，本檔內容一字未動；斷言／碼證／VERDICT／BLOCKED-BY 皆為 codex 原文。 -->
