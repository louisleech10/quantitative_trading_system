"""Freeze the IC Phase 1 1a cut1 G-NEW (flag-ON / default OOS) baseline — three-party signoff PASS."""
...
BASELINE_PATH = OUTPUT_DIR / "baseline_new_btc_1h_a384e6d2.json"
META_PATH = OUTPUT_DIR / "baseline_new_meta.json"
