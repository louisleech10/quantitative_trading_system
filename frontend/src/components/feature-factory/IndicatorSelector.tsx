...
const ENGINE_DEFINITIONS: EngineDefinition[] = [
  {
    key: 'trend',
    label: '趨勢',
    description: 'EMA、SMA、MACD、ADX、SAR',
    level: 'L1',
    levelLabel: '基礎必用',
    color: 'emerald',
    previewKey: 'trend',
  },
  {
    key: 'momentum',
    label: '動量',
    description: 'RSI、Stochastic、ROC、CCI',
    level: 'L1',
    levelLabel: '基礎必用',
    color: 'emerald',
    previewKey: 'momentum',
  },
  {
    key: 'volatility',
    label: '波動',
    description: 'ATR、Bollinger、Keltner',
    level: 'L1',
    levelLabel: '基礎必用',
    color: 'emerald',
  ...
  },
  {
    key: 'statistics',
    label: '統計',
    description: 'Skewness、Kurtosis、Linear Regression',
    level: 'L2',
    levelLabel: '中階進階',
    color: 'amber',
  ...
  },
  {
    key: 'cycle',
    label: '週期',
    description: 'Hilbert Transform、Sine、Dominant Period',
    level: 'L2',
    levelLabel: '中階進階',
    color: 'amber',
    previewKey: 'cycle',
