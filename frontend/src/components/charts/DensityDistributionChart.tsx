    ...
    <div className="glass-panel rounded-xl p-6">
      ...
      <div className="flex justify-center">
        ...
        >
          <g transform={`translate(${margin.left},${margin.top})`}>
            ...
            {/* Boxplots */}
            {renderBoxplot(positiveStats, positiveX, "#34d399", "正例 Positive")}
            {renderBoxplot(negativeStats, negativeX, "#fb7185", "反例 Negative")}
          </g>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-lg border border-emerald-400/30 bg-emerald-400/10 p-4">
          <h4 className="mb-2 font-semibold text-emerald-200">正例統計</h4>
        ...
        <div className="rounded-lg border border-rose-400/30 bg-rose-400/10 p-4">
          <h4 className="mb-2 font-semibold text-rose-200">反例統計</h4>
