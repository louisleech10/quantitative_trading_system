    ...
    return (
      <div className={`fixed inset-0 z-50 flex items-center justify-center ${className}`}>
        ...
        <div className="relative bg-white rounded-lg shadow-xl p-6 w-full max-w-md max-h-[80vh] overflow-y-auto">
          {/* 標題 */}
          <div className="mb-4">
            <h2 className="text-lg font-bold text-gray-900">💾 保存策略範本</h2>
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center ${className}`}>
      ...
      <div className="relative bg-white rounded-lg shadow-xl p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
        {/* 標題 */}
        <div className="mb-4">
          <h2 className="text-lg font-bold text-gray-900">📂 載入策略範本</h2>
          <p className="text-xs text-gray-500 mt-1">
            從已保存的範本中選擇一個載入到當前配置
          </p>
        </div>
        ...
        {templates.length === 0 ? (
          <div className="text-center py-12">
            ...
            <div className="text-sm text-gray-500">尚未保存任何範本</div>
